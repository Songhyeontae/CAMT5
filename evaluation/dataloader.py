...
from model.representation import SMILES, Representation
...
class EvalDataset(Dataset):
    ...
    def __init__(self, file_path: str, chunk_size: int = 1024):
        ...
        self.data_length = sum(1
                               for _ in open(file_path)) - 1  # Skip the header
...
def get_dataloader(data_config: DataConfig) -> DataLoader:
    dataset = EvalDataset(file_path=data_config.data_path,
