...
if __name__ == "__main__":
    ...
    instances = json_object["Instances"] + pub_chem_data["Instances"]
    ...
    with open(
            f"{DATA_PATH}/tasks/task1_chebi20_text2mol_frag_micro_train_stereo2_w_pubchem_camt5.json",
            "w") as f:
        json.dump(my_json_object, f)

    with open(f"asset/mol_vocabs/frag_camt5.txt", "w") as f:
