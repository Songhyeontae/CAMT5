...
if __name__ == "__main__":
    ...
    with open(f"{DATA_PATH}/tasks/task2_chebi20_text2mol_selfies_validation_stereo2_final.json") as f:
    ...
    with open(f"{DATA_PATH}/tasks/task2_chebi20_text2mol_selfies_validation_stereo2_sim_imp.json", "w") as f:
